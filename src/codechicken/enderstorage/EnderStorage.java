...
@Mod(name="EnderStorage", version="1.4.3.6", useMetadata = false, modid = "EnderStorage",
    dependencies = "required-after:CodeChickenCore@[0,)", acceptedMinecraftVersions=CodeChickenCorePlugin.mcVersion)
