...
public class GuiEnderItemStorage extends ContainerScreen<ContainerEnderItemStorage> {
    ...
    protected void func_230451_b_(MatrixStack mStack, int mouseX, int mouseY) {
        field_230712_o_.func_238422_b_(mStack, field_230704_d_.func_241878_f(), 8, 6, 0x404040);
        field_230712_o_.func_238422_b_(mStack, playerInventory.getName().func_241878_f(), 8, ySize - 94, 0x404040);
        if (container.chestInv.freq.hasOwner()) {
            ITextComponent name = container.chestInv.freq.getOwnerName();
            field_230712_o_.func_238422_b_(mStack, name.func_241878_f(), 170 - field_230712_o_.func_238414_a_(name), 6, 0x404040);
        }
    }
